...
app.post('/api/careers-application', upload.single('resume'), async (req, res) => {
  try {
    ...
    console.log('Careers email sent successfully:', result);
    ...
    console.error('Detailed careers error:', {
      message: error.message,
      stack: error.stack,
      code: error.code,
      command: error.command // SMTP command that failed, if applicable
    });
